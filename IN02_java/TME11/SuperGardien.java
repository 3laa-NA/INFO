...
public class SuperGardien extends Gardien implements Teleportable {
    ...
    //la méthode va retourner 1 si le super guardien s'est téléporté et 0 sinon
    public int seTeleporter(Grille grille, int proba){

        //indique si oui ou non le Super guardien s'est téléporte
        int teleportation = 0;
        ...
        if (Math.random() < proba/100.) { //on divise par 100 pour passer d'un pourcentage à une probabilité(0-1)
            ...
            try {
                ...
                //on est rentré dans le if donc il ya téléportation 
                ...
                System.out.println("Un super gardien s'est téléporté aux coordonnées ("+x+", "+y+")!");
