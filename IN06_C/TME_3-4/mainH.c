...
int main(int argc, char** argv){
    ...
    do{
        ...
        case 2: ;
            ...
            inserer(b , atoi(num) , titre , auteur );
            printf ("\nAjout fait.\n");
        ...
        case 3: ;
            ...
            if(res){
                printf("LivreH supprimé");
                break;
            }

            printf("LivreH non trouvé");
            break;
        ...
        case 4: ;
            ...
            LivreH *res2 = recherche_livre_num(b , atoi(num_2));
            if(res2){
                afficher_livre(res2);
            }
        ...
        case 5: ;
            ...
            LivreH *res_2 = recherche_livre_titre(b , titre_3);
            if(res_2){
        ...
        case 6: ;
            ...
            BiblioH *res_3 = recherche_livres_auteur(b , auteur_3);
            if(res_3){
                printf("\nVoilà une mini biblioH contenant le(s) livr(e) de l'auteur %s",auteur_3);
                afficher_biblio(res_3);
                break;
            }
            printf("\nAucun livreH n'a été trouvé!\n");
            break;
        ...
        case 7: ;
            ...
            if(dup){
                printf("voilà le(s) livreH(s) dupliqué(s):\n");
            }else{
